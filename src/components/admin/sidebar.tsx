...
import {
  ...
  Menu, ChevronLeft, MessageSquareQuote, Info,
} from "lucide-react"
...
const navItems = [
  ...
  { href: "/admin/receivables", label: "Receivables", icon: Receipt },
...
export default function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  return (
    <motion.aside
      ...
      className="fixed inset-y-0 left-0 z-40 flex flex-col bg-white border-r border-gray-100 dark:bg-slate-900 dark:border-white/5 overflow-hidden"
    >
